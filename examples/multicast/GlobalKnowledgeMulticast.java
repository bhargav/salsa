...
public class GlobalKnowledgeMulticast extends UniversalActor  {
	public static void main(String args[]) {
		...
		GlobalKnowledgeMulticast instance = (GlobalKnowledgeMulticast)new GlobalKnowledgeMulticast(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new GlobalKnowledgeMulticast(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return GlobalKnowledgeMulticast.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new GlobalKnowledgeMulticast(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return GlobalKnowledgeMulticast.getReferenceByLocation(new UAL(ual)); }
	public GlobalKnowledgeMulticast(boolean o, UAN __uan)	{ super(false,__uan); }
	public GlobalKnowledgeMulticast(boolean o, UAL __ual)	{ super(false,__ual); }
	public GlobalKnowledgeMulticast(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public GlobalKnowledgeMulticast(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public GlobalKnowledgeMulticast(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public GlobalKnowledgeMulticast()		{  }
	public GlobalKnowledgeMulticast(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.multicast.GlobalKnowledgeMulticast", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public GlobalKnowledgeMulticast self;
		public void updateSelf(ActorReference actorReference) {
			((GlobalKnowledgeMulticast)actorReference).setUAL(getUAL());
			((GlobalKnowledgeMulticast)actorReference).setUAN(getUAN());
			self = new GlobalKnowledgeMulticast(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.multicast.GlobalKnowledgeMulticast$State" );
		...
		public void act(String args[]) {
			try {
				...
				initialTime = System.currentTimeMillis();
				{
					...
					{
						Object _arguments[] = { "Time for global knowledge multicast: " };
					...
					// join block
					token_3_2.setJoinDirector();
					for (int i = 0; i<howMany; i++)					{
						// actors[i]<-ok()
						{
							Object _arguments[] = {  };
							Message message = new Message( self, actors[i], "ok", _arguments, token_3_1, token_3_2 );
							__messages.add( message );
						}
					}
					addJoinToken(token_3_2);
					// ack()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, self, "ack", _arguments, token_3_2, token_3_3 );
						__messages.add( message );
					}
					// standardOutput<-print(token)
					{
						Object _arguments[] = { token_3_3 };
						Message message = new Message( self, standardOutput, "print", _arguments, token_3_3, token_3_4 );
						__messages.add( message );
					}
					// standardOutput<-println(" ms.")
					{
						Object _arguments[] = { " ms." };
						Message message = new Message( self, standardOutput, "println", _arguments, token_3_4, null );
						__messages.add( message );
					}
				}
			}
				...
				{
					// standardOutput<-println("Usage: java examples.multicast.GlobalKnowledgeMulticast <iteration #>")
					{
						Object _arguments[] = { "Usage: java examples.multicast.GlobalKnowledgeMulticast <iteration #>" };
