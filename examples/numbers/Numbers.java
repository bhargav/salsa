...
public class Numbers extends UniversalActor  {
	public static void main(String args[]) {
		...
		Numbers instance = (Numbers)new Numbers(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Numbers(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Numbers.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Numbers(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Numbers.getReferenceByLocation(new UAL(ual)); }
	public Numbers(boolean o, UAN __uan)	{ super(false,__uan); }
	public Numbers(boolean o, UAL __ual)	{ super(false,__ual); }
	public Numbers(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Numbers(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Numbers(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Numbers()		{  }
	public Numbers(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.Numbers", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Numbers)actorReference).setUAL(getUAL());
			((Numbers)actorReference).setUAN(getUAN());
			self = new Numbers(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
