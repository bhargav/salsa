...
public class Printer extends UniversalActor  {
	public static void main(String args[]) {
		...
		Printer instance = (Printer)new Printer(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Printer(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Printer.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Printer(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Printer.getReferenceByLocation(new UAL(ual)); }
	public Printer(boolean o, UAN __uan)	{ super(false,__uan); }
	public Printer(boolean o, UAL __ual)	{ super(false,__ual); }
	public Printer(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Printer(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Printer(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Printer()		{  }
	public Printer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.Printer", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Printer)actorReference).setUAL(getUAL());
			((Printer)actorReference).setUAN(getUAN());
			self = new Printer(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.Printer$State" );
			...
			for (int i = 0; i<10; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, number, "print", _arguments, null, null );
