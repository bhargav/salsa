...
public class Migrate extends UniversalActor  {
	public static void main(String args[]) {
		...
		Migrate instance = (Migrate)new Migrate(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Migrate(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Migrate.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Migrate(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Migrate.getReferenceByLocation(new UAL(ual)); }
	public Migrate(boolean o, UAN __uan)	{ super(false,__uan); }
	public Migrate(boolean o, UAL __ual)	{ super(false,__ual); }
	public Migrate(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Migrate(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Migrate(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Migrate()		{  }
	public Migrate(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.migration.Migrate", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Migrate)actorReference).setUAL(getUAL());
			((Migrate)actorReference).setUAN(getUAN());
			self = new Migrate(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.migration.Migrate$State" );
			...
			try {
				Agent a = (Agent)Agent.getReferenceByName(new UAN(args[0]));
				{
					...
					// a<-addLocation(args[1])
					{
						...
						Message message = new Message( self, a, "addLocation", _arguments, null, token_3_0 );
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, a, "printItinerary", _arguments, token_3_1, token_3_2 );
						__messages.add( message );
					}
					// a<-printTime()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, a, "printTime", _arguments, token_3_2, null );
						__messages.add( message );
					}
				}
			}
			catch (ArrayIndexOutOfBoundsException e) {
				{
					...
					{
						Object _arguments[] = { "Usage: java migration.Migrate <uan> <UAL>" };
