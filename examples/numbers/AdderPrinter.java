...
public class AdderPrinter extends UniversalActor  {
	public static void main(String args[]) {
		...
		AdderPrinter instance = (AdderPrinter)new AdderPrinter(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new AdderPrinter(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return AdderPrinter.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new AdderPrinter(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return AdderPrinter.getReferenceByLocation(new UAL(ual)); }
	public AdderPrinter(boolean o, UAN __uan)	{ super(false,__uan); }
	public AdderPrinter(boolean o, UAL __ual)	{ super(false,__ual); }
	public AdderPrinter(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public AdderPrinter(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public AdderPrinter(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public AdderPrinter()		{  }
	public AdderPrinter(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.AdderPrinter", sourceRef);
			  }
	...
	public UniversalActor construct (Number number) {
		Object[] __arguments = { number };
	...
	public class State extends UniversalActor .State {
		public AdderPrinter self;
		public void updateSelf(ActorReference actorReference) {
			((AdderPrinter)actorReference).setUAL(getUAL());
			((AdderPrinter)actorReference).setUAN(getUAN());
			self = new AdderPrinter(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.AdderPrinter$State" );
			...
			for (int i = 0; i<10; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, number, "print", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// number<-inc()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, number, "inc", _arguments, token_3_0, null );
						__messages.add( message );
					}
				}
			}
