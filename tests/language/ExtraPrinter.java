...
public class ExtraPrinter extends TokenPrinter {
	public static void main(String args[]) {
		...
		ExtraPrinter instance = (ExtraPrinter)new ExtraPrinter(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new ExtraPrinter(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return ExtraPrinter.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new ExtraPrinter(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return ExtraPrinter.getReferenceByLocation(new UAL(ual)); }
	public ExtraPrinter(boolean o, UAN __uan)	{ super(false,__uan); }
	public ExtraPrinter(boolean o, UAL __ual)	{ super(false,__ual); }
	public ExtraPrinter(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public ExtraPrinter(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public ExtraPrinter(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public ExtraPrinter()		{  }
	public ExtraPrinter(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.ExtraPrinter", sourceRef);
			  }
	...
	public class State extends TokenPrinter.State {
		public ExtraPrinter self;
		public void updateSelf(ActorReference actorReference) {
			((ExtraPrinter)actorReference).setUAL(getUAL());
			((ExtraPrinter)actorReference).setUAN(getUAN());
			self = new ExtraPrinter(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.ExtraPrinter$State" );
