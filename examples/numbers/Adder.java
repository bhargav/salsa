...
public class Adder extends UniversalActor  {
	public static void main(String args[]) {
		...
		Adder instance = (Adder)new Adder(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Adder(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Adder.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Adder(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Adder.getReferenceByLocation(new UAL(ual)); }
	public Adder(boolean o, UAN __uan)	{ super(false,__uan); }
	public Adder(boolean o, UAL __ual)	{ super(false,__ual); }
	public Adder(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Adder(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Adder(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Adder()		{  }
	public Adder(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.Adder", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Adder)actorReference).setUAL(getUAL());
			((Adder)actorReference).setUAN(getUAN());
			self = new Adder(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.Adder$State" );
			...
			for (int i = 0; i<10; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, number, "inc", _arguments, null, null );
