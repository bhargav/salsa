...
public class Collector extends UniversalActor  {
	public static void main(String args[]) {
		...
		Collector instance = (Collector)new Collector(uan, ual,null).construct();
	...
	public Collector(boolean o, UAN __uan)	{ super(false,__uan); }
	public Collector(boolean o, UAL __ual)	{ super(false,__ual); }
	public Collector(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Collector(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Collector(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Collector()		{  }
	public Collector(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.heat_v2.Collector", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Collector)actorReference).setUAL(getUAL());
			((Collector)actorReference).setUAN(getUAN());
			self = new Collector(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.heat_v2.Collector$State" );
