...
public class CurrentContinuation extends UniversalActor  {
	public static void main(String args[]) {
		...
		CurrentContinuation instance = (CurrentContinuation)new CurrentContinuation(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CurrentContinuation(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CurrentContinuation.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CurrentContinuation(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CurrentContinuation.getReferenceByLocation(new UAL(ual)); }
	public CurrentContinuation(boolean o, UAN __uan)	{ super(false,__uan); }
	public CurrentContinuation(boolean o, UAL __ual)	{ super(false,__ual); }
	public CurrentContinuation(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public CurrentContinuation(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public CurrentContinuation(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public CurrentContinuation()		{  }
	public CurrentContinuation(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.CurrentContinuation", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public CurrentContinuation self;
		public void updateSelf(ActorReference actorReference) {
			((CurrentContinuation)actorReference).setUAL(getUAL());
			((CurrentContinuation)actorReference).setUAN(getUAN());
			self = new CurrentContinuation(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.CurrentContinuation$State" );
		...
		public int compute() {
			{
				// add(4, 1)
				{
					Object _arguments[] = { new Integer(4), new Integer(1) };
		...
		public void act(String args[]) {
			...
			}
			{
				...
				// add(token, 2)
				{
					Object _arguments[] = { token_2_0, new Integer(2) };
