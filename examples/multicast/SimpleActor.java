...
public class SimpleActor extends UniversalActor  {
	public static void main(String args[]) {
		...
		SimpleActor instance = (SimpleActor)new SimpleActor(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SimpleActor(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SimpleActor.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SimpleActor(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SimpleActor.getReferenceByLocation(new UAL(ual)); }
	public SimpleActor(boolean o, UAN __uan)	{ super(false,__uan); }
	public SimpleActor(boolean o, UAL __ual)	{ super(false,__ual); }
	public SimpleActor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public SimpleActor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public SimpleActor(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public SimpleActor()		{  }
	public SimpleActor(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.multicast.SimpleActor", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public SimpleActor self;
		public void updateSelf(ActorReference actorReference) {
			((SimpleActor)actorReference).setUAL(getUAL());
			((SimpleActor)actorReference).setUAN(getUAN());
			self = new SimpleActor(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.multicast.SimpleActor$State" );
