...
public class AddUser extends UniversalActor  {
	public static void main(String args[]) {
		...
		AddUser instance = (AddUser)new AddUser(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new AddUser(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return AddUser.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new AddUser(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return AddUser.getReferenceByLocation(new UAL(ual)); }
	public AddUser(boolean o, UAN __uan)	{ super(false,__uan); }
	public AddUser(boolean o, UAL __ual)	{ super(false,__ual); }
	public AddUser(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public AddUser(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public AddUser(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public AddUser()		{  }
	public AddUser(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.addressbook.AddUser", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((AddUser)actorReference).setUAL(getUAL());
			((AddUser)actorReference).setUAN(getUAN());
			self = new AddUser(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.addressbook.AddUser$State" );
		...
		public void act(String args[]) {
			if (args.length!=3) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.addressbook.AddUser <AddressBookUAN> <Name> <Email>" };
...
}			AddressBook book = (AddressBook)AddressBook.getReferenceByName(new UAN(args[0]));
			{
				...
				{
					Object _arguments[] = { args[1], args[2] };
					Message message = new Message( self, book, "addUser", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
