...
public class GetName extends UniversalActor  {
	public static void main(String args[]) {
		...
		GetName instance = (GetName)new GetName(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new GetName(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return GetName.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new GetName(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return GetName.getReferenceByLocation(new UAL(ual)); }
	public GetName(boolean o, UAN __uan)	{ super(false,__uan); }
	public GetName(boolean o, UAL __ual)	{ super(false,__ual); }
	public GetName(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public GetName(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public GetName(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public GetName()		{  }
	public GetName(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.addressbook.GetName", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((GetName)actorReference).setUAL(getUAL());
			((GetName)actorReference).setUAN(getUAN());
			self = new GetName(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.addressbook.GetName$State" );
			...
			if (args.length!=2) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.addressbook.GetName <AddressBookUAN> <Email>" };
				...
				// getName(args[0], args[1])
				{
					...
					Message message = new Message( self, self, "getName", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
		public void getName(String uan, String email) {
			try {
				AddressBook book = (AddressBook)AddressBook.getReferenceByName(new UAN(uan));
				{
					Token token_3_0 = new Token();
					Token token_3_1 = new Token();
					// standardOutput<-print(email+" is: ")
					{
						Object _arguments[] = { email+" is: " };
						Message message = new Message( self, standardOutput, "print", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// book<-getName(email)
					{
						Object _arguments[] = { email };
						Message message = new Message( self, book, "getName", _arguments, token_3_0, token_3_1 );
						__messages.add( message );
					}
			...
			catch (MalformedUANException e) {
				{
					...
					{
						Object _arguments[] = { "bad addressbook UAN" };
