...
public class GetEmail extends UniversalActor  {
	public static void main(String args[]) {
		...
		GetEmail instance = (GetEmail)new GetEmail(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new GetEmail(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return GetEmail.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new GetEmail(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return GetEmail.getReferenceByLocation(new UAL(ual)); }
	public GetEmail(boolean o, UAN __uan)	{ super(false,__uan); }
	public GetEmail(boolean o, UAL __ual)	{ super(false,__ual); }
	public GetEmail(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public GetEmail(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public GetEmail(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public GetEmail()		{  }
	public GetEmail(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.addressbook.GetEmail", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public GetEmail self;
		public void updateSelf(ActorReference actorReference) {
			((GetEmail)actorReference).setUAL(getUAL());
			((GetEmail)actorReference).setUAN(getUAN());
			self = new GetEmail(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.addressbook.GetEmail$State" );
			...
			if (args.length!=2) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.addressbook.GetEmail <AddressBookUAN> <Name>" };
				...
				// getEmail(args[0], args[1])
				{
					...
					Message message = new Message( self, self, "getEmail", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
		public void getEmail(String uan, String name) {
			try {
				AddressBook book = (AddressBook)AddressBook.getReferenceByName(new UAN(uan));
				{
					...
					{
						Object _arguments[] = { name+"'s email: " };
						Message message = new Message( self, standardOutput, "print", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// book<-getEmail(name)
					{
						Object _arguments[] = { name };
						Message message = new Message( self, book, "getEmail", _arguments, token_3_0, token_3_1 );
						__messages.add( message );
					}
