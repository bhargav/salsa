...
public class DelayTest extends UniversalActor  {
	public static void main(String args[]) {
		...
		DelayTest instance = (DelayTest)new DelayTest(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new DelayTest(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return DelayTest.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new DelayTest(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return DelayTest.getReferenceByLocation(new UAL(ual)); }
	public DelayTest(boolean o, UAN __uan)	{ super(false,__uan); }
	public DelayTest(boolean o, UAL __ual)	{ super(false,__ual); }
	public DelayTest(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public DelayTest(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public DelayTest(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public DelayTest()		{  }
	public DelayTest(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.DelayTest", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((DelayTest)actorReference).setUAN(getUAN());
			self = new DelayTest(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.DelayTest$State" );
