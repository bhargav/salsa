...
public class HelloWorld1 extends UniversalActor  {
	public static void main(String args[]) {
		...
		HelloWorld1 instance = (HelloWorld1)new HelloWorld1(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new HelloWorld1(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return HelloWorld1.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new HelloWorld1(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return HelloWorld1.getReferenceByLocation(new UAL(ual)); }
	public HelloWorld1(boolean o, UAN __uan)	{ super(false,__uan); }
	public HelloWorld1(boolean o, UAL __ual)	{ super(false,__ual); }
	public HelloWorld1(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public HelloWorld1(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public HelloWorld1(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public HelloWorld1()		{  }
	public HelloWorld1(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo.HelloWorld1", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public HelloWorld1 self;
		public void updateSelf(ActorReference actorReference) {
			((HelloWorld1)actorReference).setUAL(getUAL());
			((HelloWorld1)actorReference).setUAN(getUAN());
			self = new HelloWorld1(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo.HelloWorld1$State" );
