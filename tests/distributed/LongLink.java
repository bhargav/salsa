...
public class LongLink extends UniversalActor  {
	public static void main(String args[]) {
		...
		LongLink instance = (LongLink)new LongLink(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new LongLink(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return LongLink.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new LongLink(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return LongLink.getReferenceByLocation(new UAL(ual)); }
	public LongLink(boolean o, UAN __uan)	{ super(false,__uan); }
	public LongLink(boolean o, UAL __ual)	{ super(false,__ual); }
	public LongLink(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public LongLink(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public LongLink(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public LongLink()		{  }
	public LongLink(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.LongLink", sourceRef);
			  }
	...
	public UniversalActor construct (int data) {
		Object[] __arguments = { new Integer(data) };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((LongLink)actorReference).setUAN(getUAN());
			self = new LongLink(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.LongLink$State" );
...
}			LongLink ll = ((LongLink)new LongLink(this).construct(n-1));
			Token x = new Token("x");
			{
				// token x = ll<-compute()
				{
		...
		public void act(String args[]) {
			try {
				...
				LongLink x = ((LongLink)new LongLink(new UAN(args[1]), null,this).construct(n));
				{
