...
public class Man extends UniversalActor  {
	public static void main(String args[]) {
		...
		Man instance = (Man)new Man(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Man(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Man.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Man(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Man.getReferenceByLocation(new UAL(ual)); }
	public Man(boolean o, UAN __uan)	{ super(false,__uan); }
	public Man(boolean o, UAL __ual)	{ super(false,__ual); }
	public Man(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Man(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Man(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Man()		{  }
	public Man(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.babyfood.Man", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((Man)actorReference).setUAN(getUAN());
			self = new Man(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.babyfood.Man$State" );
