...
public class Multicast extends UniversalActor  {
	public static void main(String args[]) {
		...
		Multicast instance = (Multicast)new Multicast(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Multicast(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Multicast.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Multicast(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Multicast.getReferenceByLocation(new UAL(ual)); }
	public Multicast(boolean o, UAN __uan)	{ super(false,__uan); }
	public Multicast(boolean o, UAL __ual)	{ super(false,__ual); }
	public Multicast(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Multicast(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Multicast(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Multicast()		{  }
	public Multicast(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.multicast.Multicast", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Multicast self;
		public void updateSelf(ActorReference actorReference) {
			((Multicast)actorReference).setUAL(getUAL());
			((Multicast)actorReference).setUAN(getUAN());
			self = new Multicast(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.multicast.Multicast$State" );
		...
		SimpleActor[] actors;
		public void setActors(SimpleActor[] actors) {
			this.actors = actors;
		}
		public long go() {
			...
			for (int i = 0; i<actors.length; i++){
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, actors[i], "m", _arguments, null, null );
		...
		public void act(String[] args) {
			...
			for (int i = 0; i<howMany; i++){
				actors[i] = ((SimpleActor)new SimpleActor(this).construct());
			}
			{
				...
				// setActors(actors)
				{
					...
					Message message = new Message( self, self, "setActors", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// standardOutput<-print("Time for multicast: ")
				{
					Object _arguments[] = { "Time for multicast: " };
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "go", _arguments, token_2_1, token_2_2 );
					__messages.add( message );
				}
