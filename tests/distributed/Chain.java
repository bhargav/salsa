...
public class Chain extends UniversalActor  {
	public static void main(String args[]) {
		...
		Chain instance = (Chain)new Chain(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Chain(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Chain.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Chain(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Chain.getReferenceByLocation(new UAL(ual)); }
	public Chain(boolean o, UAN __uan)	{ super(false,__uan); }
	public Chain(boolean o, UAL __ual)	{ super(false,__ual); }
	public Chain(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Chain(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Chain(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Chain()		{  }
	public Chain(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.Chain", sourceRef);
			  }
	...
	public UniversalActor construct (Integer size) {
		Object[] __arguments = { size };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Chain)actorReference).setUAL(getUAL());
			((Chain)actorReference).setUAN(getUAN());
			self = new Chain(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.Chain$State" );
		...
		String nameServer = "";
		public void construct(Integer size){
			received = new boolean[size.intValue()];
		}
		public void test() {
			Chain testa = ((Chain)new Chain(this).construct());
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, testa, "sendData", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// ((Chain)self)<-go()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, ((Chain)self), "go", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
		...
		public void act(String args[]) {
			try {
				...
				for (int i = 0; i<actors.length; i++){
					actors[i] = ((Chain)new Chain(this.generateUAN(nameServer), null,this).construct(SIZE));
				}
				{
					...
					for (int i = 0; i<actors.length; i++){
						{
							...
							// actors[i]<-migrate(theaters.get(i%theaters.size()))
							{
								Object _arguments[] = { theaters.get(i%theaters.size()) };
								Message message = new Message( self, actors[i], "migrate", _arguments, null, token_5_0 );
								__messages.add( message );
							}
							// actors[i]<-test()
							{
								Object _arguments[] = {  };
								Message message = new Message( self, actors[i], "test", _arguments, token_5_0, token_3_0 );
								__messages.add( message );
							}
						}
					}
