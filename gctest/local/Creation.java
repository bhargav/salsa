...
public class Creation extends UniversalActor  {
	public static void main(String args[]) {
		...
		Creation instance = (Creation)new Creation(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Creation(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Creation.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Creation(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Creation.getReferenceByLocation(new UAL(ual)); }
	public Creation(boolean o, UAN __uan)	{ super(false,__uan); }
	public Creation(boolean o, UAL __ual)	{ super(false,__ual); }
	public Creation(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Creation(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Creation(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Creation()		{  }
	public Creation(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "gctest.local.Creation", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Creation self;
		public void updateSelf(ActorReference actorReference) {
			((Creation)actorReference).setUAL(getUAL());
			((Creation)actorReference).setUAN(getUAN());
			self = new Creation(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "gctest.local.Creation$State" );
		...
		public void act(String args[]) {
			...
			for (int i = 0; i<n; i++){
				creation = ((Creation)new Creation(this).construct(i));
			}
			{
