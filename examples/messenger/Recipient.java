...
public class Recipient extends UniversalActor  {
	public static void main(String args[]) {
		...
		Recipient instance = (Recipient)new Recipient(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Recipient(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Recipient.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Recipient(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Recipient.getReferenceByLocation(new UAL(ual)); }
	public Recipient(boolean o, UAN __uan)	{ super(false,__uan); }
	public Recipient(boolean o, UAL __ual)	{ super(false,__ual); }
	public Recipient(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Recipient(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Recipient(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Recipient()		{  }
	public Recipient(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.messenger.Recipient", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Recipient)actorReference).setUAL(getUAL());
			((Recipient)actorReference).setUAN(getUAN());
			self = new Recipient(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.messenger.Recipient$State" );
		...
		public void showMessage(String name, String msg) {
			{
				...
				{
					Object _arguments[] = { name+msg };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
		public Recipient process(Letter letter) {
			switch (failures++) {
			case 0: 			{
				...
				{
					Object _arguments[] = { token_2_0, " failed!" };
					Message message = new Message( self, self, "showMessage", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
			...
			case 1: 			{
				...
				{
					Object _arguments[] = { token_2_0, " failed again!" };
					Message message = new Message( self, self, "showMessage", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
			...
			default: 			{
				...
				{
					Object _arguments[] = { token_2_0, " was successful!" };
					Message message = new Message( self, self, "showMessage", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
