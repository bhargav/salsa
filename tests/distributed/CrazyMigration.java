...
public class CrazyMigration extends UniversalActor  {
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CrazyMigration(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CrazyMigration.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CrazyMigration(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CrazyMigration.getReferenceByLocation(new UAL(ual)); }
	public CrazyMigration(boolean o, UAN __uan)	{ super(false,__uan); }
	public CrazyMigration(boolean o, UAL __ual)	{ super(false,__ual); }
	public CrazyMigration(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public CrazyMigration(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public CrazyMigration(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((CrazyMigration)actorReference).setUAN(getUAN());
			self = new CrazyMigration(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.CrazyMigration$State" );
