...
public class UniqueNumbers extends UniversalActor  {
	public static void main(String args[]) {
		...
		UniqueNumbers instance = (UniqueNumbers)new UniqueNumbers(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new UniqueNumbers(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return UniqueNumbers.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new UniqueNumbers(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return UniqueNumbers.getReferenceByLocation(new UAL(ual)); }
	public UniqueNumbers(boolean o, UAN __uan)	{ super(false,__uan); }
	public UniqueNumbers(boolean o, UAL __ual)	{ super(false,__ual); }
	public UniqueNumbers(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public UniqueNumbers(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public UniqueNumbers(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public UniqueNumbers()		{  }
	public UniqueNumbers(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.UniqueNumbers", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public UniqueNumbers self;
		public void updateSelf(ActorReference actorReference) {
			((UniqueNumbers)actorReference).setUAL(getUAL());
			((UniqueNumbers)actorReference).setUAN(getUAN());
			self = new UniqueNumbers(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.UniqueNumbers$State" );
		...
		public void act(String args[]) {
			...
			Incrementer incrementer = ((Incrementer)new Incrementer(this).construct(number));
			{
				Token token_2_0 = new Token();
				// incrementer<-go()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, incrementer, "go", _arguments, null, token_2_0 );
