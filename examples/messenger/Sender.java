...
public class Sender extends UniversalActor  {
	public static void main(String args[]) {
		...
		Sender instance = (Sender)new Sender(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Sender(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Sender.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Sender(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Sender.getReferenceByLocation(new UAL(ual)); }
	public Sender(boolean o, UAN __uan)	{ super(false,__uan); }
	public Sender(boolean o, UAL __ual)	{ super(false,__ual); }
	public Sender(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Sender(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Sender(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Sender()		{  }
	public Sender(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.messenger.Sender", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Sender)actorReference).setUAL(getUAL());
			((Sender)actorReference).setUAN(getUAN());
			self = new Sender(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.messenger.Sender$State" );
		...
		public void act(String[] args) {
			Recipient recipient = ((Recipient)new Recipient(this).construct());
			Letter letter = ((Letter)new Letter(this).construct(((Sender)self), "Try Once Messenger"));
			{
				// recipient<-process(letter)
				{
					Object _arguments[] = { letter };
					Message message = new Message( self, recipient, "process", _arguments, null, null );
					__messages.add( message );
				}
			}
			recipient = ((Recipient)new Recipient(this).construct());
			letter = ((Letter)new Letter(this).construct(((Sender)self), "Try Forever Messenger"));
			{
				Token token_2_0 = new Token();
				// recipient<-process(letter)
				{
					Object _arguments[] = { letter };
					Message message = new Message( self, recipient, "process", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// letter<-retry(token)
				{
					Object _arguments[] = { token_2_0 };
					Message message = new Message( self, letter, "retry", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
			recipient = ((Recipient)new Recipient(this).construct());
			letter = ((Letter)new Letter(this).construct(((Sender)self), "Try Twice Messenger"));
			{
				Token token_2_0 = new Token();
				// recipient<-process(letter)
				{
				...
				{
					Object _arguments[] = { token_2_0 };
					Message message = new Message( self, letter, "failed", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
		}
		...
		public void log(Letter letter) {
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, letter, "returnName", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// combineString(token, " reported failure.")
				{
					Object _arguments[] = { token_2_0, " reported failure." };
				...
				// standardError<-println(token)
				{
					...
					Message message = new Message( self, standardError, "println", _arguments, token_2_1, null );
					__messages.add( message );
				}
			}
		}
