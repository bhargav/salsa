...
public class Fibonacci extends UniversalActor  {
	public static void main(String args[]) {
		...
		Fibonacci instance = (Fibonacci)new Fibonacci(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Fibonacci(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Fibonacci.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Fibonacci(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Fibonacci.getReferenceByLocation(new UAL(ual)); }
	public Fibonacci(boolean o, UAN __uan)	{ super(false,__uan); }
	public Fibonacci(boolean o, UAL __ual)	{ super(false,__ual); }
	public Fibonacci(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Fibonacci(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Fibonacci(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Fibonacci()		{  }
	public Fibonacci(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.fibonacci.Fibonacci", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Fibonacci self;
		public void updateSelf(ActorReference actorReference) {
			((Fibonacci)actorReference).setUAL(getUAL());
			((Fibonacci)actorReference).setUAN(getUAN());
			self = new Fibonacci(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.fibonacci.Fibonacci$State" );
