...
public class AcknowledgedMulticast extends UniversalActor  {
	public static void main(String args[]) {
		...
		AcknowledgedMulticast instance = (AcknowledgedMulticast)new AcknowledgedMulticast(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new AcknowledgedMulticast(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return AcknowledgedMulticast.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new AcknowledgedMulticast(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return AcknowledgedMulticast.getReferenceByLocation(new UAL(ual)); }
	public AcknowledgedMulticast(boolean o, UAN __uan)	{ super(false,__uan); }
	public AcknowledgedMulticast(boolean o, UAL __ual)	{ super(false,__ual); }
	public AcknowledgedMulticast(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public AcknowledgedMulticast(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public AcknowledgedMulticast(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public AcknowledgedMulticast()		{  }
	public AcknowledgedMulticast(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.multicast.AcknowledgedMulticast", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public AcknowledgedMulticast self;
		public void updateSelf(ActorReference actorReference) {
			((AcknowledgedMulticast)actorReference).setUAL(getUAL());
			((AcknowledgedMulticast)actorReference).setUAN(getUAN());
			self = new AcknowledgedMulticast(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.multicast.AcknowledgedMulticast$State" );
			...
			try {
				...
				initialTime = System.currentTimeMillis();
				{
					...
					for (int i = 0; i<howMany; i++){
						SimpleActor simpleActor = ((SimpleActor)new SimpleActor(this).construct());
						{
							// simpleActor<-m()
							{
								Object _arguments[] = {  };
								Message message = new Message( self, simpleActor, "m", _arguments, token_3_0, token_3_1 );
								__messages.add( message );
							}
						}
					}
					...
					// standardOutput<-print(token)
					{
						...
						Message message = new Message( self, standardOutput, "print", _arguments, token_3_2, token_3_3 );
						__messages.add( message );
					}
					// standardOutput<-println(" ms.")
					{
						Object _arguments[] = { " ms." };
						Message message = new Message( self, standardOutput, "println", _arguments, token_3_3, null );
						__messages.add( message );
					}
				}
			}
			catch (Exception e) {
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.multicast.AcknowledgedMulticast <iteration #>" };
