...
public class RemoteSend extends UniversalActor  {
	public static void main(String args[]) {
		...
		RemoteSend instance = (RemoteSend)new RemoteSend(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new RemoteSend(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return RemoteSend.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new RemoteSend(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return RemoteSend.getReferenceByLocation(new UAL(ual)); }
	public RemoteSend(boolean o, UAN __uan)	{ super(false,__uan); }
	public RemoteSend(boolean o, UAL __ual)	{ super(false,__ual); }
	public RemoteSend(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public RemoteSend(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public RemoteSend(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public RemoteSend()		{  }
	public RemoteSend(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.migration.RemoteSend", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((RemoteSend)actorReference).setUAL(getUAL());
			((RemoteSend)actorReference).setUAN(getUAN());
			self = new RemoteSend(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public void act(String[] args) {
			try {
				UniversalActor a = (UniversalActor)UniversalActor.getReferenceByName(new UAN(args[0]));
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, a, "printItinerary", _arguments, null, null );
			...
			catch (ArrayIndexOutOfBoundsException e) {
				{
					...
					{
						Object _arguments[] = { "Usage: java migration.RemoteSend <UAN>" };
			...
			catch (MalformedUALException e) {
				{
					...
					{
						Object _arguments[] = { "Error creating UAL: "+e };
