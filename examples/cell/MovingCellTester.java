...
public class MovingCellTester extends UniversalActor  {
	public static void main(String args[]) {
		...
		MovingCellTester instance = (MovingCellTester)new MovingCellTester(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new MovingCellTester(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return MovingCellTester.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new MovingCellTester(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return MovingCellTester.getReferenceByLocation(new UAL(ual)); }
	public MovingCellTester(boolean o, UAN __uan)	{ super(false,__uan); }
	public MovingCellTester(boolean o, UAL __ual)	{ super(false,__ual); }
	public MovingCellTester(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public MovingCellTester(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public MovingCellTester(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public MovingCellTester()		{  }
	public MovingCellTester(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.cell.MovingCellTester", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public MovingCellTester self;
		public void updateSelf(ActorReference actorReference) {
			((MovingCellTester)actorReference).setUAL(getUAL());
			((MovingCellTester)actorReference).setUAN(getUAN());
			self = new MovingCellTester(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.cell.MovingCellTester$State" );
			...
			if (args.length!=3) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.cell.MovingCellTester <UAN> <UAL1> <UAL2>" };
...
}			Cell c = ((Cell)new Cell(new UAN(args[0]), new UAL(args[1]),this).construct(new Integer(5)));
			{
				...
				{
					Object _arguments[] = { "Initial Value:" };
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, c, "get", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
				...
				{
					Object _arguments[] = { new Integer(10) };
					Message message = new Message( self, c, "set", _arguments, token_2_2, token_2_3 );
					__messages.add( message );
				}
				// standardOutput<-print("New Value:")
				{
					Object _arguments[] = { "New Value:" };
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, c, "get", _arguments, token_2_4, token_2_5 );
					__messages.add( message );
				}
				// standardOutput<-println(token)
				{
				...
				// c<-migrate(args[2])
				{
					...
					Message message = new Message( self, c, "migrate", _arguments, token_2_6, token_2_7 );
					__messages.add( message );
				}
				// c<-set(new Integer(20))
				{
					Object _arguments[] = { new Integer(20) };
					Message message = new Message( self, c, "set", _arguments, token_2_7, token_2_8 );
					__messages.add( message );
				}
				// standardOutput<-print("New Value at New Location:")
				{
					Object _arguments[] = { "New Value at New Location:" };
					Message message = new Message( self, standardOutput, "print", _arguments, token_2_8, token_2_9 );
					__messages.add( message );
				}
				// c<-get()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, c, "get", _arguments, token_2_9, token_2_10 );
					__messages.add( message );
				}
				// standardOutput<-println(token)
				{
					Object _arguments[] = { token_2_10 };
					Message message = new Message( self, standardOutput, "println", _arguments, token_2_10, null );
					__messages.add( message );
				}
			}
		}
