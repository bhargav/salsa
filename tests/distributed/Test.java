...
public class Test extends UniversalActor  {
	public static void main(String args[]) {
		...
		Test instance = (Test)new Test(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Test(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Test.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Test(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Test.getReferenceByLocation(new UAL(ual)); }
	public Test(boolean o, UAN __uan)	{ super(false,__uan); }
	public Test(boolean o, UAL __ual)	{ super(false,__ual); }
	public Test(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Test(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Test(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Test()		{  }
	public Test(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.Test", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Test)actorReference).setUAL(getUAL());
			((Test)actorReference).setUAN(getUAN());
			self = new Test(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.Test$State" );
		...
		public void act(String args[]) {
			try {
				...
				for (int i = 0; i<actors.length; i++){
					actors[i] = ((Test)new Test(this.generateUAN(nameServer), null,this).construct());
				}
				{
					...
					for (int i = 0; i<actors.length; i++){
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, actors[i], "one", _arguments, token_5_0, token_3_0 );
								__messages.add( message );
							}
						}
					}
