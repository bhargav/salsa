...
public class CycleAdder extends UniversalActor  {
	public static void main(String args[]) {
		...
		CycleAdder instance = (CycleAdder)new CycleAdder(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CycleAdder(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CycleAdder.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CycleAdder(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CycleAdder.getReferenceByLocation(new UAL(ual)); }
	public CycleAdder(boolean o, UAN __uan)	{ super(false,__uan); }
	public CycleAdder(boolean o, UAL __ual)	{ super(false,__ual); }
	public CycleAdder(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public CycleAdder(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public CycleAdder(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public CycleAdder()		{  }
	public CycleAdder(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.localgc.CycleAdder", sourceRef);
			  }
	...
	public UniversalActor construct (int targetN, int n) {
		Object[] __arguments = { new Integer(targetN), new Integer(n) };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((CycleAdder)actorReference).setUAN(getUAN());
			self = new CycleAdder(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.localgc.CycleAdder$State" );
		...
		int currentSum = 0;
		CycleAdder fp;
		void construct(int targetN, int n){
			this.targetN = targetN;
			this.n = n;
			currentSum = 0;
			fp = null;
		}
		public void compute(CycleAdder next) {
			if (this.n==0) {{
				fp = next;
				{
					// fp<-add(0)
				...
				CycleAdder ca = ((CycleAdder)new CycleAdder(this).construct(targetN, this.n-1));
				fp = ca;
				{
					// ca<-compute(next)
					{
		...
		public void add(Integer num) {
			if (this.n==0) {{
				System.out.println(this.n+num.intValue());
			}
}			else {{
				{
