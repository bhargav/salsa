...
public class ExceptionTest extends UniversalActor  {
	public static void main(String args[]) {
		...
		ExceptionTest instance = (ExceptionTest)new ExceptionTest(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new ExceptionTest(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return ExceptionTest.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new ExceptionTest(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return ExceptionTest.getReferenceByLocation(new UAL(ual)); }
	public ExceptionTest(boolean o, UAN __uan)	{ super(false,__uan); }
	public ExceptionTest(boolean o, UAL __ual)	{ super(false,__ual); }
	public ExceptionTest(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public ExceptionTest(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public ExceptionTest(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public ExceptionTest()		{  }
	public ExceptionTest(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.ExceptionTest", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public ExceptionTest self;
		public void updateSelf(ActorReference actorReference) {
			((ExceptionTest)actorReference).setUAL(getUAL());
			((ExceptionTest)actorReference).setUAN(getUAN());
			self = new ExceptionTest(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.ExceptionTest$State" );
		...
		public void act(String[] args) throws Exception{
			{
				// standardOutput<-print("Testing exceptions")
				{
					Object _arguments[] = { "Testing exceptions" };
