...
public class AwareActor extends SimpleActor {
	public static void main(String args[]) {
		...
		AwareActor instance = (AwareActor)new AwareActor(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new AwareActor(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return AwareActor.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new AwareActor(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return AwareActor.getReferenceByLocation(new UAL(ual)); }
	public AwareActor(boolean o, UAN __uan)	{ super(false,__uan); }
	public AwareActor(boolean o, UAL __ual)	{ super(false,__ual); }
	public AwareActor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public AwareActor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public AwareActor(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public AwareActor()		{  }
	public AwareActor(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.multicast.AwareActor", sourceRef);
			  }
	...
	public class State extends SimpleActor.State {
		public AwareActor self;
		public void updateSelf(ActorReference actorReference) {
			((AwareActor)actorReference).setUAL(getUAL());
			((AwareActor)actorReference).setUAN(getUAN());
			self = new AwareActor(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.multicast.AwareActor$State" );
