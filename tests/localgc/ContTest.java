...
public class ContTest extends UniversalActor  {
	public static void main(String args[]) {
		...
		ContTest instance = (ContTest)new ContTest(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new ContTest(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return ContTest.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new ContTest(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return ContTest.getReferenceByLocation(new UAL(ual)); }
	public ContTest(boolean o, UAN __uan)	{ super(false,__uan); }
	public ContTest(boolean o, UAL __ual)	{ super(false,__ual); }
	public ContTest(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public ContTest(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public ContTest(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public ContTest()		{  }
	public ContTest(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.localgc.ContTest", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((ContTest)actorReference).setUAN(getUAN());
			self = new ContTest(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.localgc.ContTest$State" );
		...
		public Integer f4(Integer i) {
			return new Integer(i.intValue()+1);
		}
		public Integer f5(Object[] obj) {
			int sum = 0;
		...
		public String f7(Integer a, String b) {
			return b+","+a;
		}
		public String f8() {
			if (true) {{
