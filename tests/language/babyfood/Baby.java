package tests.language.babyfood;
...
public class Baby extends Man {
	public static void main(String args[]) {
		...
		Baby instance = (Baby)new Baby(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Baby(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Baby.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Baby(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Baby.getReferenceByLocation(new UAL(ual)); }
	public Baby(boolean o, UAN __uan)	{ super(false,__uan); }
	public Baby(boolean o, UAL __ual)	{ super(false,__ual); }
	public Baby(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Baby(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Baby(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Baby()		{  }
	public Baby(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.babyfood.Baby", sourceRef);
			  }
	...
	public class State extends Man.State {
		public Baby self;
		public void updateSelf(ActorReference actorReference) {
			((Baby)actorReference).setUAL(getUAL());
			((Baby)actorReference).setUAN(getUAN());
			self = new Baby(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.babyfood.Baby$State" );
		...
		public void act(String[] args) {
			Man m = ((Man)new Man(this).construct());
			Baby b = ((Baby)new Baby(this).construct());
			Food f = ((Food)new Food(this).construct());
			BabyFood bf = ((BabyFood)new BabyFood(this).construct());
			{
				// m<-eat(f)
				{
					Object _arguments[] = { f };
