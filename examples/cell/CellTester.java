...
public class CellTester extends UniversalActor  {
	public static void main(String args[]) {
		...
		CellTester instance = (CellTester)new CellTester(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new CellTester(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return CellTester.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new CellTester(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return CellTester.getReferenceByLocation(new UAL(ual)); }
	public CellTester(boolean o, UAN __uan)	{ super(false,__uan); }
	public CellTester(boolean o, UAL __ual)	{ super(false,__ual); }
	public CellTester(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public CellTester(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public CellTester(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public CellTester()		{  }
	public CellTester(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.cell.CellTester", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public CellTester self;
		public void updateSelf(ActorReference actorReference) {
			((CellTester)actorReference).setUAL(getUAL());
			((CellTester)actorReference).setUAN(getUAN());
			self = new CellTester(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.cell.CellTester$State" );
		...
		public void act(String args[]) {
			Cell c = ((Cell)new Cell(this).construct(new Integer(5)));
			{
				...
				// standardOutput<-println(token)
				{
					...
					Message message = new Message( self, standardOutput, "println", _arguments, token_2_5, null );
					__messages.add( message );
				}
			}
		}
