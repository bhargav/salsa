...
public class Letter extends UniversalActor  {
	public static void main(String args[]) {
		...
		Letter instance = (Letter)new Letter(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Letter(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Letter.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Letter(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Letter.getReferenceByLocation(new UAL(ual)); }
	public Letter(boolean o, UAN __uan)	{ super(false,__uan); }
	public Letter(boolean o, UAL __ual)	{ super(false,__ual); }
	public Letter(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Letter(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Letter(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Letter()		{  }
	public Letter(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.messenger.Letter", sourceRef);
			  }
	...
	public UniversalActor construct (Sender _sender, String _name) {
		Object[] __arguments = { _sender, _name };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Letter)actorReference).setUAL(getUAL());
			((Letter)actorReference).setUAN(getUAN());
			self = new Letter(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.messenger.Letter$State" );
		...
		Sender sender;
		String name;
		void construct(Sender _sender, String _name){
			sender = _sender;
			name = _name;
		}
		...
		public void retry(Recipient recipient) {
			if (recipient!=null) {			{
				...
				// recipient<-process(((Letter)self))
				{
					Object _arguments[] = { ((Letter)self) };
					Message message = new Message( self, recipient, "process", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// ((Letter)self)<-retry(token)
				{
					Object _arguments[] = { token_2_0 };
					Message message = new Message( self, ((Letter)self), "retry", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
}		}
		public void failed(Recipient recipient) {
			if (recipient!=null) {{
...

				{
					...
					{
						Object _arguments[] = { ((Letter)self) };
						Message message = new Message( self, recipient, "process", _arguments, null, token_3_0 );
						__messages.add( message );
					}
					// ((Letter)self)<-failedTwice(token)
					{
						Object _arguments[] = { token_3_0 };
						Message message = new Message( self, ((Letter)self), "failedTwice", _arguments, token_3_0, null );
						__messages.add( message );
					}
				}
			}
		...
		public void failedTwice(Recipient recipient) {
			if (recipient!=null) {			{
				// sender<-log(((Letter)self))
				{
					Object _arguments[] = { ((Letter)self) };
					Message message = new Message( self, sender, "log", _arguments, null, null );
					__messages.add( message );
				}
			}
}		}
