...
public class SequentialNumbers extends UniversalActor  {
	public static void main(String args[]) {
		...
		SequentialNumbers instance = (SequentialNumbers)new SequentialNumbers(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new SequentialNumbers(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return SequentialNumbers.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new SequentialNumbers(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return SequentialNumbers.getReferenceByLocation(new UAL(ual)); }
	public SequentialNumbers(boolean o, UAN __uan)	{ super(false,__uan); }
	public SequentialNumbers(boolean o, UAL __ual)	{ super(false,__ual); }
	public SequentialNumbers(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public SequentialNumbers(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public SequentialNumbers(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public SequentialNumbers()		{  }
	public SequentialNumbers(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.SequentialNumbers", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public SequentialNumbers self;
		public void updateSelf(ActorReference actorReference) {
			((SequentialNumbers)actorReference).setUAL(getUAL());
			((SequentialNumbers)actorReference).setUAN(getUAN());
			self = new SequentialNumbers(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.SequentialNumbers$State" );
		...
		public void act(String args[]) {
			...
			AdderPrinter adderprinter = ((AdderPrinter)new AdderPrinter(this).construct(number));
			for (int i = 0; i<10; i++){
				{
					// adderprinter<-go()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, adderprinter, "go", _arguments, null, null );
