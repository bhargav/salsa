...
public class NoSuchMessage extends UniversalActor  {
	public static void main(String args[]) {
		...
		NoSuchMessage instance = (NoSuchMessage)new NoSuchMessage(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new NoSuchMessage(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return NoSuchMessage.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new NoSuchMessage(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return NoSuchMessage.getReferenceByLocation(new UAL(ual)); }
	public NoSuchMessage(boolean o, UAN __uan)	{ super(false,__uan); }
	public NoSuchMessage(boolean o, UAL __ual)	{ super(false,__ual); }
	public NoSuchMessage(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public NoSuchMessage(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public NoSuchMessage(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public NoSuchMessage()		{  }
	public NoSuchMessage(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.NoSuchMessage", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public NoSuchMessage self;
		public void updateSelf(ActorReference actorReference) {
			((NoSuchMessage)actorReference).setUAL(getUAL());
			((NoSuchMessage)actorReference).setUAN(getUAN());
			self = new NoSuchMessage(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.NoSuchMessage$State" );
		...
		public void act(String[] args) {
			{
				// ((NoSuchMessage)self)<-m()
				{
					Object _arguments[] = {  };
					Message message = new Message( self, ((NoSuchMessage)self), "m", _arguments, null, null );
