...
public class Nqueens extends UniversalActor  {
	...
	public Nqueens(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.Nqueens", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.Nqueens$State" );
		...
		public void act(String args[]) {
			try {
				...
				for (int i = 0; i<actors.length; i++){
					actors[i] = ((Nqueens)new Nqueens(new UAN("uan://"+nameServer+"/a"+i), new UAL("rmsp://"+theaters.get(i%theaters.size())+"/a"+i),this).construct());
				}
