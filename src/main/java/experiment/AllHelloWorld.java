...
public class AllHelloWorld extends UniversalActor  {
	...
	public AllHelloWorld(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "demo.AllHelloWorld", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "demo.AllHelloWorld$State" );
		...
		public void pump(HelloWorld1 world, Nqueens nqueen, String[] argNqueens, Fibonacci fib, String[] argFibonacci, int count) {
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "dummy", _arguments, token_2_1, null );
					__messages.add( message );
				}
			}
		}
				...
				for (int i = 0; i<10; i++){
					{
						...
						{
							Object _arguments[] = { worlds[i], nqueens, argNqueens, fib, argFibonacci, count };
