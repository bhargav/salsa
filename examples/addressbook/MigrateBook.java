...
public class MigrateBook extends UniversalActor  {
	public static void main(String args[]) {
		...
		MigrateBook instance = (MigrateBook)new MigrateBook(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new MigrateBook(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return MigrateBook.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new MigrateBook(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return MigrateBook.getReferenceByLocation(new UAL(ual)); }
	public MigrateBook(boolean o, UAN __uan)	{ super(false,__uan); }
	public MigrateBook(boolean o, UAL __ual)	{ super(false,__ual); }
	public MigrateBook(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public MigrateBook(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public MigrateBook(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public MigrateBook()		{  }
	public MigrateBook(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.addressbook.MigrateBook", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public MigrateBook self;
		public void updateSelf(ActorReference actorReference) {
			((MigrateBook)actorReference).setUAL(getUAL());
			((MigrateBook)actorReference).setUAN(getUAN());
			self = new MigrateBook(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.addressbook.MigrateBook$State" );
		...
		public void act(String args[]) {
			if (args.length!=2) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java examples.addressbook.MigrateBook <AddressBookUAN> <NewUAL>" };
...
}			AddressBook book = (AddressBook)AddressBook.getReferenceByName(new UAN(args[0]));
			{
				// book<-migrate(args[1])
				{
					...
					Message message = new Message( self, book, "migrate", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
