...
public class Food extends UniversalActor  {
	public static void main(String args[]) {
		...
		Food instance = (Food)new Food(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Food(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Food.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Food(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Food.getReferenceByLocation(new UAL(ual)); }
	public Food(boolean o, UAN __uan)	{ super(false,__uan); }
	public Food(boolean o, UAL __ual)	{ super(false,__ual); }
	public Food(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Food(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Food(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Food()		{  }
	public Food(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.babyfood.Food", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Food)actorReference).setUAL(getUAL());
			((Food)actorReference).setUAN(getUAN());
			self = new Food(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.babyfood.Food$State" );
