...
public class Cell extends UniversalActor  {
	public static void main(String args[]) {
		...
		Cell instance = (Cell)new Cell(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Cell(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Cell.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Cell(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Cell.getReferenceByLocation(new UAL(ual)); }
	public Cell(boolean o, UAN __uan)	{ super(false,__uan); }
	public Cell(boolean o, UAL __ual)	{ super(false,__ual); }
	public Cell(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Cell(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Cell(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Cell()		{  }
	public Cell(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.cell.Cell", sourceRef);
			  }
	...
	public UniversalActor construct (Object initialContents) {
		Object[] __arguments = { initialContents };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Cell)actorReference).setUAL(getUAL());
			((Cell)actorReference).setUAN(getUAN());
			self = new Cell(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.cell.Cell$State" );
		...
		Object contents;
		void construct(Object initialContents){
		...
		public Object get() {
			{
				...
				{
					Object _arguments[] = { "Returning cell value:"+contents };
		...
		public void set(Object newContents) {
			{
				...
				{
					Object _arguments[] = { "Setting cell value to:"+newContents };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
