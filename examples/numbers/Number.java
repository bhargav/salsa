...
public class Number extends UniversalActor  {
	public static void main(String args[]) {
		...
		Number instance = (Number)new Number(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Number(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Number.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Number(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Number.getReferenceByLocation(new UAL(ual)); }
	public Number(boolean o, UAN __uan)	{ super(false,__uan); }
	public Number(boolean o, UAL __ual)	{ super(false,__ual); }
	public Number(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Number(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Number(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Number()		{  }
	public Number(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.Number", sourceRef);
			  }
	...
	public UniversalActor construct (int number) {
		Object[] __arguments = { new Integer(number) };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Number)actorReference).setUAL(getUAL());
			((Number)actorReference).setUAN(getUAN());
			self = new Number(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.Number$State" );
