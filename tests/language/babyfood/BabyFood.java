...
public class BabyFood extends Food {
	public static void main(String args[]) {
		...
		BabyFood instance = (BabyFood)new BabyFood(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new BabyFood(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return BabyFood.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new BabyFood(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return BabyFood.getReferenceByLocation(new UAL(ual)); }
	public BabyFood(boolean o, UAN __uan)	{ super(false,__uan); }
	public BabyFood(boolean o, UAL __ual)	{ super(false,__ual); }
	public BabyFood(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public BabyFood(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public BabyFood(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public BabyFood()		{  }
	public BabyFood(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.language.babyfood.BabyFood", sourceRef);
			  }
	...
	public class State extends Food.State {
		public BabyFood self;
		public void updateSelf(ActorReference actorReference) {
			((BabyFood)actorReference).setUAL(getUAL());
			((BabyFood)actorReference).setUAN(getUAN());
			self = new BabyFood(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.language.babyfood.BabyFood$State" );
