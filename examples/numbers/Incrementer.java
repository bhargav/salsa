...
public class Incrementer extends UniversalActor  {
	public static void main(String args[]) {
		...
		Incrementer instance = (Incrementer)new Incrementer(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Incrementer(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Incrementer.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Incrementer(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Incrementer.getReferenceByLocation(new UAL(ual)); }
	public Incrementer(boolean o, UAN __uan)	{ super(false,__uan); }
	public Incrementer(boolean o, UAL __ual)	{ super(false,__ual); }
	public Incrementer(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Incrementer(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Incrementer(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Incrementer()		{  }
	public Incrementer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.numbers.Incrementer", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Incrementer self;
		public void updateSelf(ActorReference actorReference) {
			((Incrementer)actorReference).setUAL(getUAL());
			((Incrementer)actorReference).setUAN(getUAN());
			self = new Incrementer(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.numbers.Incrementer$State" );
		...
		public void go() {
			if ((i++)==100) {			return;
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, number, "print", _arguments, null, token_2_0 );
