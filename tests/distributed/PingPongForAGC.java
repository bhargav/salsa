...
public class PingPongForAGC extends UniversalActor  {
	public static void main(String args[]) {
		...
		PingPongForAGC instance = (PingPongForAGC)new PingPongForAGC(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new PingPongForAGC(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return PingPongForAGC.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new PingPongForAGC(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return PingPongForAGC.getReferenceByLocation(new UAL(ual)); }
	public PingPongForAGC(boolean o, UAN __uan)	{ super(false,__uan); }
	public PingPongForAGC(boolean o, UAL __ual)	{ super(false,__ual); }
	public PingPongForAGC(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public PingPongForAGC(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public PingPongForAGC(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public PingPongForAGC()		{  }
	public PingPongForAGC(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.PingPongForAGC", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((PingPongForAGC)actorReference).setUAN(getUAN());
			self = new PingPongForAGC(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.PingPongForAGC$State" );
		...
		public void act(String[] args) {
			try {
				myActor = ((PingPongForAGC)new PingPongForAGC(new UAN(args[0]), null,this).construct());
				{
		...
		public void startPingPong() {
			...
			for (int i = 0; i<pingpongActors.length; i++)pingpongActors[i] = ((PingPongForAGC)new PingPongForAGC(new UAN("uan://match/pingpong_"+i), null,this).construct());
		...
		public void setAcquaintance(PingPongForAGC acquaintance) {
			myActor = acquaintance;
		}
		public void removeAcquaintance() {
			myActor = null;
		}
