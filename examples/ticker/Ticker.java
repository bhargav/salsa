...
public class Ticker extends UniversalActor  {
	public static void main(String args[]) {
		...
		Ticker instance = (Ticker)new Ticker(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Ticker(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Ticker.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Ticker(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Ticker.getReferenceByLocation(new UAL(ual)); }
	public Ticker(boolean o, UAN __uan)	{ super(false,__uan); }
	public Ticker(boolean o, UAL __ual)	{ super(false,__ual); }
	public Ticker(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Ticker(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Ticker(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Ticker()		{  }
	public Ticker(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "examples.ticker.Ticker", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Ticker)actorReference).setUAL(getUAL());
			((Ticker)actorReference).setUAN(getUAN());
			self = new Ticker(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "examples.ticker.Ticker$State" );
		...
		public void tick() {
			...
			}
			{
				...
				{
					Object _arguments[] = { new Integer(t) };
		...
		public void act(String args[]) {
			...
			try {
				Ticker t1 = ((Ticker)new Ticker(new UAN("uan://"+args[0]+"/a"), new UAL("rmsp://"+args[1]+"/a"),this).construct());
				Ticker t2 = ((Ticker)new Ticker(new UAN("uan://"+args[0]+"/b"), new UAL("rmsp://"+args[2]+"/b"),this).construct());
				{
					// t1<-tick()
					{
						Object _arguments[] = {  };
						Message message = new Message( self, t1, "tick", _arguments, null, null );
						__messages.add( message );
					}
				}
				{
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, t2, "tick", _arguments, null, null );
						__messages.add( message );
					}
				}
				{
					...
					{
						Object _arguments[] = { "rmsp://"+args[3]+"/a" };
						Message message = new Message( self, t1, "migrate", _arguments, null, null );
						__messages.add( message );
					}
				}
				{
					...
					{
						Object _arguments[] = { "rmsp://"+args[3]+"/b" };
						Message message = new Message( self, t2, "migrate", _arguments, null, null );
						__messages.add( message );
					}
				}
			}
