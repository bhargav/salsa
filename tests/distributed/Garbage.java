...
public class Garbage extends UniversalActor  {
	public static void main(String args[]) {
		...
		Garbage instance = (Garbage)new Garbage(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Garbage(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Garbage.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Garbage(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Garbage.getReferenceByLocation(new UAL(ual)); }
	public Garbage(boolean o, UAN __uan)	{ super(false,__uan); }
	public Garbage(boolean o, UAL __ual)	{ super(false,__ual); }
	public Garbage(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Garbage(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Garbage(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Garbage()		{  }
	public Garbage(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "tests.distributed.Garbage", sourceRef);
			  }
	...
	public UniversalActor construct (Garbage ref, Integer myid) {
		Object[] __arguments = { ref, myid };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			...
			((Garbage)actorReference).setUAN(getUAN());
			self = new Garbage(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "tests.distributed.Garbage$State" );
		...
		int myid = 0;
		Garbage prev;
		public void construct(Garbage ref, Integer myid){
			prev = ref;
			this.myid = myid.intValue();
		}
		public void set(Garbage ref) {
			prev = ref;
		}
		...
		public void act(String args[]) {
			try {
				...
				actors[0] = ((Garbage)new Garbage(new UAN("uan://"+nameServer+"/garbage/"+0), null,this).construct(null, new Integer(0)));
				for (int i = 1; i<actors.length; i++){
					actors[i] = ((Garbage)new Garbage(new UAN("uan://"+nameServer+"/garbage/"+i), null,this).construct(actors[i-1], new Integer(i)));
				}
				{
